...
![The Activity view: nine runs in flight across Develop, QA and Release on two boxes, with each lane's own queue underneath.](/images/blog/supermog-dash/activity.webp)
