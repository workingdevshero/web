...
The rooftop hero scene came out of Grok strong: moonlit, caped, gloriously uncluttered. But it wasn't *ours* yet. So the human took it into Venice and used **Google's Nano Banana Pro** image edit model to add the beard (obviously) and the `</>` emblem on the chest — the same mark our mascot has worn since day one — then upscaled it to 21:9 and cropped a square companion for mobile.
