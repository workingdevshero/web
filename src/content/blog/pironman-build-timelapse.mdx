...
- *"That's not the animation we actually use."* The first draft's OLED mascot was hand-invented; the fix was porting the real animation code from the repo, pixel for pixel.
